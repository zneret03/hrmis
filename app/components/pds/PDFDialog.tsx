...
const familyBackgroundNames = new Set(
  familyBackgroundFields.map((f) => f.name),
);
          ...
          <Fragment key={`${column.name}-${index}`}>
            ...
            {data.length > 1 && colIndex === template.columns.length - 1 && (
              <button
                ...
                className="absolute z-20 flex items-center justify-center rounded-full bg-red-500 text-white hover:bg-red-700"
                style={{
              ...
              >
                ...
                {index + 1 === workExperienceFieldTemplate.page && (
                  <button
                    ...
                    className="absolute z-20 rounded-md bg-blue-500 p-1 text-white hover:bg-green-700"
                    style={{
                ...
                {index + 1 === voluntaryWorkFieldTemplate.page && (
                  <button
                    ...
                    className="absolute z-20 rounded-md bg-blue-500 p-1 text-white hover:bg-purple-700"
                    style={{
                ...
                {index + 1 === learningAndDevelopmentFieldTemplate.page && (
                  <button
                    onClick={addLdRow}
                    className="absolute z-20 rounded-md bg-blue-500 p-1 text-white hover:bg-yellow-700"
                    style={{
