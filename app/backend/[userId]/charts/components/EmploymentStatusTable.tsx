...
export function EmploymentStatusTable({
  ...
  const columns: ColumnDef<EmploymentStatus>[] = React.useMemo(
    () => [
      {
  ...
  return (
    <div className="w-full">
      <h1 className="text-3xl font-bold">Employment Status Statistics</h1>
