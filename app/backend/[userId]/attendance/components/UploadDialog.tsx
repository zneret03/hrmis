  ...
  return (
    <Dialog open={isOpenDialog} onOpenChange={() => toggleOpen?.(false, null)}>
      <DialogContent className="sm:max-w-[30rem]">
        ...
        <main className="grid grid-cols-2 gap-2">
          <section>
            ...
            <div
              ...
              className="flex cursor-pointer flex-col items-center justify-center gap-1 rounded-sm p-4 text-center ring-2 ring-gray-500/20 hover:ring-blue-500 focus:ring-blue-500"
            >
        ...
        {!!uploadedFile.file && (
          <span className="flex items-center justify-between gap-2 rounded-md bg-blue-500 px-3 py-2 text-sm font-medium text-white">
